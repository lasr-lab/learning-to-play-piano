...
def c_major_chord_progression_one_hands() -> midi_file.MidiFile:
    """C Major chord progression for one hands."""
    seq = music_pb2.NoteSequence()
    ...
    # C Major chord.
    seq.notes.add(pitch=60, start_time=0, end_time=2, velocity=80, part=0)
    seq.notes.add(pitch=64, start_time=0, end_time=2, velocity=80, part=2)

    # F Major chord.
    seq.notes.add(pitch=65, start_time=2, end_time=4, velocity=80, part=0)
    seq.notes.add(pitch=69, start_time=2, end_time=4, velocity=80, part=2)
    seq.notes.add(pitch=72, start_time=2, end_time=4, velocity=80, part=4)

    # G Major chord.
    seq.notes.add(pitch=67, start_time=4, end_time=6, velocity=80, part=0)
    seq.notes.add(pitch=71, start_time=4, end_time=6, velocity=80, part=2)
    seq.notes.add(pitch=74, start_time=4, end_time=6, velocity=80, part=4)

    # C Major chord.
    seq.notes.add(pitch=60, start_time=6, end_time=8, velocity=80, part=0)
    seq.notes.add(pitch=64, start_time=6, end_time=8, velocity=80, part=2)
    seq.notes.add(pitch=67, start_time=6, end_time=8, velocity=80, part=4)
...
MIDI_NAME_TO_CALLABLE: Dict[str, Callable[[], midi_file.MidiFile]] = {
    ...
    "CMajorChordProgressionOneHand": c_major_chord_progression_one_hands,
